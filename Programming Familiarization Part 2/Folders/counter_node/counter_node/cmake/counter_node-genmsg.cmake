...
get_filename_component(_filename "/home/brucekimrok/catkin_ws/src/counter_node/srv/counter.srv" NAME_WE)
add_custom_target(_counter_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "counter_node" "/home/brucekimrok/catkin_ws/src/counter_node/srv/counter.srv" ""
)
...
_generate_srv_cpp(counter_node
  "/home/brucekimrok/catkin_ws/src/counter_node/srv/counter.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/counter_node)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/counter_node\")")
  # install generated code
  install(
